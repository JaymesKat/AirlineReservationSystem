...
public class ReservationController {
    ...
    @GetMapping
   // @PreAuthorize("hasAnyAuthority(" + AppConstant.ROLE_USER + "," + AppConstant.ROLE_AGENT + ")")
   ...
   // @PreAuthorize("hasRole(" + AppConstant.ROLE_AGENT + ")")
   ...
   // @PreAuthorize("hasAuthority(" + AppConstant.ROLE_USER + ")")
